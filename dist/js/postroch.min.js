...
try{statusText=xhr.statusText}catch(e){statusText=""}status||!s.isLocal||s.crossDomain?1223===status&&(status=204):status=responses.text?200:404}}catch(firefoxAccessException){isAbort||complete(-1,firefoxAccessException)}responses&&complete(status,statusText,responses,responseHeaders)},s.async?4===xhr.readyState?setTimeout(callback):(handle=++xhrId,xhrOnUnloadAbort&&(xhrCallbacks||(xhrCallbacks={},jQuery(window).unload(xhrOnUnloadAbort)),xhrCallbacks[handle]=callback),xhr.onreadystatechange=callback):callback()},abort:function(){callback&&callback(undefined,!0)}}}});var fxNow,timerId,rfxtypes=/^(?:toggle|show|hide)$/,rfxnum=new RegExp("^(?:([+-])=|)("+core_pnum+")([a-z%]*)$","i"),rrun=/queueHooks$/,animationPrefilters=[defaultPrefilter],tweeners={"*":[function(prop,value){var tween=this.createTween(prop,value),target=tween.cur(),parts=rfxnum.exec(value),unit=parts&&parts[3]||(jQuery.cssNumber[prop]?"":"px"),start=(jQuery.cssNumber[prop]||"px"!==unit&&+target)&&rfxnum.exec(jQuery.css(tween.elem,prop)),scale=1,maxIterations=20;if(start&&start[3]!==unit){unit=unit||start[3],parts=parts||[],start=+target||1;do scale=scale||".5",start/=scale,jQuery.style(tween.elem,prop,start+unit);while(scale!==(scale=tween.cur()/target)&&1!==scale&&--maxIterations)}return parts&&(start=tween.start=+start||+target||0,tween.unit=unit,tween.end=parts[1]?start+(parts[1]+1)*parts[2]:+parts[2]),tween}]};jQuery.Animation=jQuery.extend(Animation,{tweener:function(props,callback){jQuery.isFunction(props)?(callback=props,props=["*"]):props=props.split(" ");for(var prop,index=0,length=props.length;length>index;index++)prop=props[index],tweeners[prop]=tweeners[prop]||[],tweeners[prop].unshift(callback)},prefilter:function(callback,prepend){prepend?animationPrefilters.unshift(callback):animationPrefilters.push(callback)}}),jQuery.Tween=Tween,Tween.prototype={constructor:Tween,init:function(elem,options,prop,end,easing,unit){this.elem=elem,this.prop=prop,this.easing=easing||"swing",this.options=options,this.start=this.now=this.cur(),this.end=end,this.unit=unit||(jQuery.cssNumber[prop]?"":"px")},cur:function(){var hooks=Tween.propHooks[this.prop];return hooks&&hooks.get?hooks.get(this):Tween.propHooks._default.get(this)},run:function(percent){var eased,hooks=Tween.propHooks[this.prop];return this.pos=eased=this.options.duration?jQuery.easing[this.easing](percent,this.options.duration*percent,0,1,this.options.duration):percent,this.now=(this.end-this.start)*eased+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),hooks&&hooks.set?hooks.set(this):Tween.propHooks._default.set(this),this}},Tween.prototype.init.prototype=Tween.prototype,Tween.propHooks={_default:{get:function(tween){var result;return null==tween.elem[tween.prop]||tween.elem.style&&null!=tween.elem.style[tween.prop]?(result=jQuery.css(tween.elem,tween.prop,""),result&&"auto"!==result?result:0):tween.elem[tween.prop]},set:function(tween){jQuery.fx.step[tween.prop]?jQuery.fx.step[tween.prop](tween):tween.elem.style&&(null!=tween.elem.style[jQuery.cssProps[tween.prop]]||jQuery.cssHooks[tween.prop])?jQuery.style(tween.elem,tween.prop,tween.now+tween.unit):tween.elem[tween.prop]=tween.now}}},Tween.propHooks.scrollTop=Tween.propHooks.scrollLeft={set:function(tween){tween.elem.nodeType&&tween.elem.parentNode&&(tween.elem[tween.prop]=tween.now)}},jQuery.each(["toggle","show","hide"],function(i,name){var cssFn=jQuery.fn[name];jQuery.fn[name]=function(speed,easing,callback){return null==speed||"boolean"==typeof speed?cssFn.apply(this,arguments):this.animate(genFx(name,!0),speed,easing,callback)}}),jQuery.fn.extend({fadeTo:function(speed,to,easing,callback){return this.filter(isHidden).css("opacity",0).show().end().animate({opacity:to},speed,easing,callback)},animate:function(prop,speed,easing,callback){var empty=jQuery.isEmptyObject(prop),optall=jQuery.speed(speed,easing,callback),doAnimation=function(){var anim=Animation(this,jQuery.extend({},prop),optall);(empty||jQuery._data(this,"finish"))&&anim.stop(!0)};return doAnimation.finish=doAnimation,empty||optall.queue===!1?this.each(doAnimation):this.queue(optall.queue,doAnimation)},stop:function(type,clearQueue,gotoEnd){var stopQueue=function(hooks){var stop=hooks.stop;delete hooks.stop,stop(gotoEnd)};return"string"!=typeof type&&(gotoEnd=clearQueue,clearQueue=type,type=undefined),clearQueue&&type!==!1&&this.queue(type||"fx",[]),this.each(function(){var dequeue=!0,index=null!=type&&type+"queueHooks",timers=jQuery.timers,data=jQuery._data(this);if(index)data[index]&&data[index].stop&&stopQueue(data[index]);else for(index in data)data[index]&&data[index].stop&&rrun.test(index)&&stopQueue(data[index]);for(index=timers.length;index--;)timers[index].elem!==this||null!=type&&timers[index].queue!==type||(timers[index].anim.stop(gotoEnd),dequeue=!1,timers.splice(index,1));(dequeue||!gotoEnd)&&jQuery.dequeue(this,type)})},finish:function(type){return type!==!1&&(type=type||"fx"),this.each(function(){var index,data=jQuery._data(this),queue=data[type+"queue"],hooks=data[type+"queueHooks"],timers=jQuery.timers,length=queue?queue.length:0;for(data.finish=!0,jQuery.queue(this,type,[]),hooks&&hooks.stop&&hooks.stop.call(this,!0),index=timers.length;index--;)timers[index].elem===this&&timers[index].queue===type&&(timers[index].anim.stop(!0),timers.splice(index,1));for(index=0;length>index;index++)queue[index]&&queue[index].finish&&queue[index].finish.call(this);delete data.finish})}}),jQuery.each({slideDown:genFx("show"),slideUp:genFx("hide"),slideToggle:genFx("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(name,props){jQuery.fn[name]=function(speed,easing,callback){return this.animate(props,speed,easing,callback)}}),jQuery.speed=function(speed,easing,fn){var opt=speed&&"object"==typeof speed?jQuery.extend({},speed):{complete:fn||!fn&&easing||jQuery.isFunction(speed)&&speed,duration:speed,easing:fn&&easing||easing&&!jQuery.isFunction(easing)&&easing};return opt.duration=jQuery.fx.off?0:"number"==typeof opt.duration?opt.duration:opt.duration in jQuery.fx.speeds?jQuery.fx.speeds[opt.duration]:jQuery.fx.speeds._default,(null==opt.queue||opt.queue===!0)&&(opt.queue="fx"),opt.old=opt.complete,opt.complete=function(){jQuery.isFunction(opt.old)&&opt.old.call(this),opt.queue&&jQuery.dequeue(this,opt.queue)},opt},jQuery.easing={linear:function(p){return p},swing:function(p){return.5-Math.cos(p*Math.PI)/2}},jQuery.timers=[],jQuery.fx=Tween.prototype.init,jQuery.fx.tick=function(){var timer,timers=jQuery.timers,i=0;for(fxNow=jQuery.now();i<timers.length;i++)timer=timers[i],timer()||timers[i]!==timer||timers.splice(i--,1);timers.length||jQuery.fx.stop(),fxNow=undefined},jQuery.fx.timer=function(timer){timer()&&jQuery.timers.push(timer)&&jQuery.fx.start()},jQuery.fx.interval=13,jQuery.fx.start=function(){timerId||(timerId=setInterval(jQuery.fx.tick,jQuery.fx.interval))},jQuery.fx.stop=function(){clearInterval(timerId),timerId=null},jQuery.fx.speeds={slow:600,fast:200,_default:400},jQuery.fx.step={},jQuery.expr&&jQuery.expr.filters&&(jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length}),jQuery.fn.offset=function(options){if(arguments.length)return options===undefined?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,box={top:0,left:0},elem=this[0],doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(typeof elem.getBoundingClientRect!==core_strundefined&&(box=elem.getBoundingClientRect()),win=getWindow(doc),{top:box.top+(win.pageYOffset||docElem.scrollTop)-(docElem.clientTop||0),left:box.left+(win.pageXOffset||docElem.scrollLeft)-(docElem.clientLeft||0)}):box},jQuery.offset={setOffset:function(elem,options,i){var position=jQuery.css(elem,"position");"static"===position&&(elem.style.position="relative");var curTop,curLeft,curElem=jQuery(elem),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&jQuery.inArray("auto",[curCSSTop,curCSSLeft])>-1,props={},curPosition={};calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,curOffset)),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({position:function(){if(this[0]){var offsetParent,offset,parentOffset={top:0,left:0},elem=this[0];return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent||docElem;offsetParent&&!jQuery.nodeName(offsetParent,"html")&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||docElem})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top=/Y/.test(prop);jQuery.fn[method]=function(val){return jQuery.access(this,function(elem,method,val){var win=getWindow(elem);return val===undefined?win?prop in win?win[prop]:win.document.documentElement[method]:elem[method]:void(win?win.scrollTo(top?jQuery(win).scrollLeft():val,top?val:jQuery(win).scrollTop()):elem[method]=val)},method,val,arguments.length,null)}}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return jQuery.access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):value===undefined?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:undefined,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"object"==typeof module&&module&&"object"==typeof module.exports?module.exports=jQuery:(window.jQuery=window.$=jQuery,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery}))}(window),(window._gsQueue||(window._gsQueue=[])).push(function(){_gsDefine("TweenMax",["core.Animation","core.SimpleTimeline","TweenLite"],function(g,k,d){var f=function(e,l,b){d.call(this,e,l,b),this._cycle=0,this._yoyo=1==this.vars.yoyo,this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||0,this._dirty=!0},h=f.prototype=d.to({},.1,{}),c=[];h.constructor=f,h.kill()._gc=!1,f.killTweensOf=f.killDelayedCallsTo=d.killTweensOf,f.getTweensOf=d.getTweensOf,h.invalidate=function(){return this._yoyo=1==this.vars.yoyo,this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||0,this._uncache(!0),d.prototype.invalidate.call(this)},h.updateTo=function(e,l){var a,b=this.ratio;l&&null!=this.timeline&&this._startTime<this._timeline._time&&(this._startTime=this._timeline._time,this._uncache(!1),this._gc?this._enabled(!0,!1):this._timeline.insert(this,this._startTime-this._delay));for(a in e)this.vars[a]=e[a];if(this._initted)if(l)this._initted=!1;else if(this._notifyPluginsOfEnabled&&this._firstPT&&d._onPluginEvent("_onDisable",this),.998<this._time/this._duration)b=this._time,this.render(0,!0,!1),this._initted=!1,this.render(b,!0,!1);else if(0<this._time){this._initted=!1,this._init(),b=1/(1-b),a=this._firstPT;for(var c;a;)c=a.s+a.c,a.c*=b,a.s=c-a.c,a=a._next}return this},h.render=function(e,b,j){var w,p,a=this._dirty?this.totalDuration():this._totalDuration,d=this._time,f=this._totalTime,h=this._cycle;if(e>=a)this._totalTime=a,this._cycle=this._repeat,this._yoyo&&0!==(1&this._cycle)?(this._time=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0):(this._time=this._duration,this.ratio=this._ease._calcEnd?this._ease.getRatio(1):1),this._reversed||(w=!0,p="onComplete"),0===this._duration&&((0===e||0>this._rawPrevTime)&&this._rawPrevTime!==e&&(j=!0),this._rawPrevTime=e);else if(0>=e)this._totalTime=this._time=this._cycle=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0,(0!==f||0===this._duration&&0<this._rawPrevTime)&&(p="onReverseComplete",w=this._reversed),0>e?(this._active=!1,0===this._duration&&(0<=this._rawPrevTime&&(j=!0),this._rawPrevTime=e)):this._initted||(j=!0);else if(this._totalTime=this._time=e,0!==this._repeat&&(e=this._duration+this._repeatDelay,this._cycle=this._totalTime/e>>0,0!==this._cycle&&this._cycle===this._totalTime/e&&this._cycle--,this._time=this._totalTime-this._cycle*e,this._yoyo&&0!==(1&this._cycle)&&(this._time=this._duration-this._time),this._time>this._duration?this._time=this._duration:0>this._time&&(this._time=0)),this._easeType){var e=this._time/this._duration,a=this._easeType,g=this._easePower;(1===a||3===a&&e>=.5)&&(e=1-e),3===a&&(e*=2),1===g?e*=e:2===g?e*=e*e:3===g?e*=e*e*e:4===g&&(e*=e*e*e*e),this.ratio=1===a?1-e:2===a?e:.5>this._time/this._duration?e/2:1-e/2}else this.ratio=this._ease.getRatio(this._time/this._duration);if(d!==this._time||j){for(this._initted||(this._init(),!w&&this._time&&(this.ratio=this._ease.getRatio(this._time/this._duration))),!this._active&&!this._paused&&(this._active=!0),0!=f||!this.vars.onStart||0===this._totalTime&&0!==this._duration||b||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||c),j=this._firstPT;j;)j.f?j.t[j.p](j.c*this.ratio+j.s):j.t[j.p]=j.c*this.ratio+j.s,j=j._next;this._onUpdate&&(b||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||c)),this._cycle!=h&&(b||this._gc||this.vars.onRepeat&&this.vars.onRepeat.apply(this.vars.onRepeatScope||this,this.vars.onRepeatParams||c)),p&&!this._gc&&(w&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),b||this.vars[p]&&this.vars[p].apply(this.vars[p+"Scope"]||this,this.vars[p+"Params"]||c))}},f.to=function(e,b,j){return new f(e,b,j)},f.from=function(e,b,j){return j.runBackwards=!0,0!=j.immediateRender&&(j.immediateRender=!0),new f(e,b,j)},f.fromTo=function(e,b,j,a){return a.startAt=j,j.immediateRender&&(a.immediateRender=!0),new f(e,b,a)},f.staggerTo=f.allTo=function(e,b,a,u,c,d,h){var m,x,y,u=u||0,g=[],p=e.length,k=a.delay||0;for(x=0;p>x;x++){m={};for(y in a)m[y]=a[y];m.delay=k,x===p-1&&c&&(m.onComplete=function(){a.onComplete&&a.onComplete.apply(a.onCompleteScope,a.onCompleteParams),c.apply(h,d)}),g[x]=new f(e[x],b,m),k+=u}return g},f.staggerFrom=f.allFrom=function(e,b,a,u,c,d,h){return a.runBackwards=!0,0!=a.immediateRender&&(a.immediateRender=!0),f.staggerTo(e,b,a,u,c,d,h)},f.staggerFromTo=f.allFromTo=function(e,b,a,c,d,h,g,k){return c.startAt=a,a.immediateRender&&(c.immediateRender=!0),f.staggerTo(e,b,c,d,h,g,k)},f.delayedCall=function(e,b,a,c,d){return new f(b,0,{delay:e,onComplete:b,onCompleteParams:a,onCompleteScope:c,onReverseComplete:b,onReverseCompleteParams:a,onReverseCompleteScope:c,immediateRender:!1,useFrames:d,overwrite:0})},f.set=function(e,b){return new f(e,0,b)},f.isTweening=function(e){for(var a,e=d.getTweensOf(e),b=e.length;-1<--b;)if((a=e[b])._active||a._startTime===a.timeline._time&&a.timeline._active)return!0;return!1},f.getAllTweens=function(e){return a(g._rootTimeline,e).concat(a(g._rootFramesTimeline,e))};var a=function(e,b){for(var j=[],c=0,f=e._first;f;)f instanceof d?j[c++]=f:(b&&(j[c++]=f),j=j.concat(a(f,b)),c=j.length),f=f._next;return j};f.killAll=function(e,b,a,c){null==b&&(b=!0),null==a&&(a=!0);for(var h,g,d=getAllTweens(0!=c),f=d.length,c=b&&a&&c;-1<--f;)g=d[f],(c||g instanceof k||(h=g.target===g.vars.onComplete)&&a||b&&!h)&&(e?g.totalTime(g.totalDuration()):g._enabled(!1,!1))},f.pauseAll=function(e,a,j){b(!0,e,a,j)},f.resumeAll=function(e,a,j){b(!1,e,a,j)};var b=function(e,b,a,c){void 0==b&&(b=!0),void 0==a&&(a=!0);for(var h,g,d=getAllTweens(c),c=b&&a&&c,f=d.length;-1<--f;)g=d[f],(c||g instanceof k||(h=g.target===g.vars.onComplete)&&a||b&&!h)&&g.paused(e)};return h.progress=function(b){return arguments.length?this.totalTime(this.duration()*b+this._cycle*this._duration,!1):this._time/this.duration()},h.totalProgress=function(b){return arguments.length?this.totalTime(this.totalDuration()*b,!1):this._totalTime/this.totalDuration()},h.time=function(b,a){return arguments.length?(this._dirty&&this.totalDuration(),b>this._duration&&(b=this._duration),this._yoyo&&0!==(1&this._cycle)?b=this._duration-b+this._cycle*(this._duration+this._repeatDelay):0!=this._repeat&&(b+=this._cycle*(this._duration+this._repeatDelay)),this.totalTime(b,a)):this._time},h.totalDuration=function(b){return arguments.length?-1==this._repeat?this:this.duration((b-this._repeat*this._repeatDelay)/(this._repeat+1)):(this._dirty&&(this._totalDuration=-1===this._repeat?999999999999:this._duration*(this._repeat+1)+this._repeatDelay*this._repeat,this._dirty=!1),this._totalDuration)},h.repeat=function(b){return arguments.length?(this._repeat=b,this._uncache(!0)):this._repeat},h.repeatDelay=function(b){return arguments.length?(this._repeatDelay=b,this._uncache(!0)):this._repeatDelay},h.yoyo=function(b){return arguments.length?(this._yoyo=b,this):this._yoyo},f},!0),_gsDefine("TimelineLite",["core.Animation","core.SimpleTimeline","TweenLite"],function(g,k,d){var f=function(b){k.call(this,b),this._labels={},this.autoRemoveChildren=1==this.vars.autoRemoveChildren,this.smoothChildTiming=1==this.vars.smoothChildTiming,this._sortChildren=!0,this._onUpdate=this.vars.onUpdate;for(var e,a,b=h.length;-1<--b;)if(a=this.vars[h[b]])for(e=a.length;-1<--e;)"{self}"===a[e]&&(a=this.vars[h[b]]=a.concat(),a[e]=this);this.vars.tweens instanceof Array&&this.insertMultiple(this.vars.tweens,0,this.vars.align||"normal",this.vars.stagger||0)},h=["onStartParams","onUpdateParams","onCompleteParams","onReverseCompleteParams","onRepeatParams"],c=[],a=f.prototype=new k;return a.constructor=f,a.kill()._gc=!1,a.to=function(b,e,a,c,f){return this.insert(new d(b,e,a),this._parseTimeOrLabel(f)+(c||0))},a.from=function(b,e,a,c,f){return this.insert(d.from(b,e,a),this._parseTimeOrLabel(f)+(c||0))},a.fromTo=function(b,e,a,c,f,h){return this.insert(d.fromTo(b,e,a,c),this._parseTimeOrLabel(h)+(f||0))},a.staggerTo=function(b,e,a,c,u,h,g,k,w){for(g=new f({onComplete:g,onCompleteParams:k,onCompleteScope:w}),c=c||0,k=0;k<b.length;k++)g.insert(new d(b[k],e,a),k*c);return this.insert(g,this._parseTimeOrLabel(h)+(u||0))},a.staggerFrom=function(b,e,a,c,d,f,h,g,k){return null==a.immediateRender&&(a.immediateRender=!0),a.runBackwards=!0,this.staggerTo(b,e,a,c,d,f,h,g,k)},a.staggerFromTo=function(b,e,a,c,d,f,h,g,k,p){return c.startAt=a,a.immediateRender&&(c.immediateRender=!0),this.staggerTo(b,e,c,d,f,h,g,k,p)},a.call=function(b,e,a,c,f){return this.insert(d.delayedCall(0,b,e,a),this._parseTimeOrLabel(f)+(c||0))},a.set=function(b,e,a,c){return e.immediateRender=!1,this.insert(new d(b,0,e),this._parseTimeOrLabel(c)+(a||0))},f.exportRoot=function(b,e){b=b||{},null==b.smoothChildTiming&&(b.smoothChildTiming=!0);var a=new f(b),c=a._timeline;null==e&&(e=!0),c._remove(a,!0),a._startTime=0,a._rawPrevTime=a._time=a._totalTime=c._time;for(var h,u=c._first;u;)h=u._next,(!e||!(u instanceof d&&u.target==u.vars.onComplete))&&a.insert(u,u._startTime-u._delay),u=h;return c.insert(a,0),a},a.insert=function(b,e){if(!(b instanceof g)){if(b instanceof Array)return this.insertMultiple(b,e);if("string"==typeof b)return this.addLabel(b,this._parseTimeOrLabel(e||0,!0));if("function"!=typeof b)throw"ERROR: Cannot insert() "+b+" into the TimelineLite/Max because it is neither a tween, timeline, function, nor a String.";b=d.delayedCall(0,b)}if(k.prototype.insert.call(this,b,this._parseTimeOrLabel(e||0,!0)),this._gc&&!this._paused&&this._startTime+(b._startTime+b._totalDuration/b._timeScale)/this._timeScale>this.timeline._time)for(var a=this;a._gc&&a._timeline;)a.totalTime(a._totalTime,!0),a=a._timeline;return this},a.remove=function(b){if(b instanceof g)return this._remove(b,!1);if(b instanceof Array){for(var a=b.length;-1<--a;)this.remove(b[a]);return this}return"string"==typeof b?this.removeLabel(b):this.kill(null,b)},a.append=function(b,a){return this.insert(b,this.duration()+(a||0))},a.insertMultiple=function(b,a,c,j){for(var d,c=c||"normal",j=j||0,h=this._parseTimeOrLabel(a||0,!0),g=b.length,a=0;g>a;a++)(d=b[a])instanceof Array&&(d=new f({tweens:d})),this.insert(d,h),"string"==typeof d||"function"==typeof d||("sequence"===c?h=d._startTime+d.totalDuration()/d._timeScale:"start"===c&&(d._startTime-=d.delay())),h+=j;return this._uncache(!0)},a.appendMultiple=function(b,a,c,d){return this.insertMultiple(b,this.duration()+(a||0),c,d)},a.addLabel=function(b,a){return this._labels[b]=a,this},a.removeLabel=function(b){return delete this._labels[b],this},a.getLabelTime=function(b){return null!=this._labels[b]?this._labels[b]:-1},a._parseTimeOrLabel=function(b,a){return null==b?this.duration():"string"==typeof b&&isNaN(b)?null==this._labels[b]?a?this._labels[b]=this.duration():0:this._labels[b]:Number(b)},a.seek=function(b,a){return this.totalTime(this._parseTimeOrLabel(b,!1),0!=a)},a.stop=function(){return this.paused(!0)},a.gotoAndPlay=function(b,a){return k.prototype.play.call(this,b,a)},a.gotoAndStop=function(b,a){return this.pause(b,a)},a.render=function(b,a,l){this._gc&&this._enabled(!0,!1),this._active=!this._paused;var w,p,t,d=this._dirty?this.totalDuration():this._totalDuration,f=this._time,h=this._startTime,g=this._timeScale,k=this._paused;if(b>=d?(this._totalTime=this._time=d,this._reversed||this._hasPausedChild()||(w=!0,t="onComplete",0!==this._duration||!(0===b||0>this._rawPrevTime))||this._rawPrevTime!==b&&(l=!0),this._rawPrevTime=b,b=d+1e-6):0>=b?(this._totalTime=this._time=0,(0!==f||0===this._duration&&0<this._rawPrevTime)&&(t="onReverseComplete",w=this._reversed),0>b?(this._active=!1,0===this._duration&&0<=this._rawPrevTime&&(l=!0)):this._initted||(l=!0),this._rawPrevTime=b,b=-1e-6):this._totalTime=this._time=this._rawPrevTime=b,this._time!==f||l){if(this._initted||(this._initted=!0),0===f&&this.vars.onStart&&0!==this._time&&(a||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||c)),this._time>f)for(l=this._first;l&&(p=l._next,!this._paused||k);)(l._active||l._startTime<=this._time&&!l._paused&&!l._gc)&&(l._reversed?l.render((l._dirty?l.totalDuration():l._totalDuration)-(b-l._startTime)*l._timeScale,a,!1):l.render((b-l._startTime)*l._timeScale,a,!1)),l=p;else for(l=this._last;l&&(p=l._prev,!this._paused||k);)(l._active||l._startTime<=f&&!l._paused&&!l._gc)&&(l._reversed?l.render((l._dirty?l.totalDuration():l._totalDuration)-(b-l._startTime)*l._timeScale,a,!1):l.render((b-l._startTime)*l._timeScale,a,!1)),l=p;this._onUpdate&&(a||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||c)),!t||this._gc||h!==this._startTime&&g==this._timeScale||(0===this._time||d>=this.totalDuration())&&(w&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),a||this.vars[t]&&this.vars[t].apply(this.vars[t+"Scope"]||this,this.vars[t+"Params"]||c))}},a._hasPausedChild=function(){for(var b=this._first;b;){if(b._paused||b instanceof f&&b._hasPausedChild())return!0;b=b._next}return!1},a.getChildren=function(b,a,c,f){for(var f=f||-9999999999,h=[],g=this._first,k=0;g;)g._startTime<f||(g instanceof d?0!=a&&(h[k++]=g):(0!=c&&(h[k++]=g),0!=b&&(h=h.concat(g.getChildren(!0,a,c)),k=h.length))),g=g._next;return h},a.getTweensOf=function(b,a){for(var c=d.getTweensOf(b),f=c.length,h=[],g=0;-1<--f;)(c[f].timeline===this||a&&this._contains(c[f]))&&(h[g++]=c[f]);return h},a._contains=function(a){for(a=a.timeline;a;){if(a===this)return!0;a=a.timeline}return!1},a.shiftChildren=function(a,e,c){for(var c=c||0,d=this._first;d;)d._startTime>=c&&(d._startTime+=a),d=d._next;if(e)for(var f in this._labels)this._labels[f]>=c&&(this._labels[f]+=a);return this._uncache(!0)},a._kill=function(a,e){if(null==a&&null==e)return this._enabled(!1,!1);for(var c=null==e?this.getChildren(!0,!0,!1):this.getTweensOf(e),d=c.length,f=!1;-1<--d;)c[d]._kill(a,e)&&(f=!0);return f},a.clear=function(a){var e=this.getChildren(!1,!0,!0),c=e.length;for(this._time=this._totalTime=0;-1<--c;)e[c]._enabled(!1,!1);return 0!=a&&(this._labels={}),this._uncache(!0)},a.invalidate=function(){for(var a=this._first;a;)a.invalidate(),a=a._next;return this},a._enabled=function(a,e){if(a==this._gc)for(var c=this._first;c;)c._enabled(a,!0),c=c._next;return k.prototype._enabled.call(this,a,e)},a.progress=function(a){return arguments.length?this.totalTime(this.duration()*a,!1):this._time/this.duration()},a.duration=function(a){return arguments.length?(0!==this.duration()&&0!==a&&this.timeScale(this._duration/a),this):(this._dirty&&this.totalDuration(),this._duration)},a.totalDuration=function(a){if(!arguments.length){if(this._dirty){for(var f,e=0,c=this._first,d=-999999999999;c;)f=c._next,c._startTime<d&&this._sortChildren?this.insert(c,c._startTime-c._delay):d=c._startTime,0>c._startTime&&(e-=c._startTime,this.shiftChildren(-c._startTime,!1,-9999999999)),c=c._startTime+(c._dirty?c.totalDuration():c._totalDuration)/c._timeScale,c>e&&(e=c),c=f;this._duration=this._totalDuration=e,this._dirty=!1}return this._totalDuration}return 0!==this.totalDuration()&&0!==a&&this.timeScale(this._totalDuration/a),this},a.usesFrames=function(){for(var a=this._timeline;a._timeline;)a=a._timeline;return a===g._rootFramesTimeline},a.rawTime=function(){return this._paused||0!==this._totalTime&&this._totalTime!==this._totalDuration?this._totalTime:(this._timeline.rawTime()-this._startTime)*this._timeScale},f},!0),_gsDefine("TimelineMax",["TimelineLite","TweenLite","easing.Ease"],function(g,k,d){var f=function(a){g.call(this,a),this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||0,this._cycle=0,this._yoyo=1==this.vars.yoyo,this._dirty=!0},h=[],c=new d(null,null,1,0),d=f.prototype=new g;return d.constructor=f,d.kill()._gc=!1,f.version=12,d.invalidate=function(){return this._yoyo=1==this.vars.yoyo,this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||0,this._uncache(!0),g.prototype.invalidate.call(this)},d.addCallback=function(a,b,c,d){return this.insert(k.delayedCall(0,a,c,d),b)},d.removeCallback=function(a,b){if(null==b)this._kill(null,a);else for(var c=this.getTweensOf(a,!1),d=c.length,f=this._parseTimeOrLabel(b,!1);-1<--d;)c[d]._startTime===f&&c[d]._enabled(!1,!1);return this},d.tweenTo=function(a,b){var d,f,b=b||{},e={ease:c,overwrite:2,useFrames:this.usesFrames(),immediateRender:!1};for(d in b)e[d]=b[d];return e.time=this._parseTimeOrLabel(a,!1),f=new k(this,Math.abs(Number(e.time)-this._time)/this._timeScale||.001,e),e.onStart=function(){f.target.paused(!0),f.vars.time!=f.target.time()&&f.duration(Math.abs(f.vars.time-f.target.time())/f.target._timeScale),b.onStart&&b.onStart.apply(b.onStartScope||f,b.onStartParams||h)},f},d.tweenFromTo=function(a,b,c){return c=c||{},c.startAt={time:this._parseTimeOrLabel(a,!1)},a=this.tweenTo(b,c),a.duration(Math.abs(a.vars.time-a.vars.startAt.time)/this._timeScale||.001)},d.render=function(a,b,c){this._gc&&this._enabled(!0,!1),this._active=!this._paused;var t,m,d=this._dirty?this.totalDuration():this._totalDuration,f=this._time,g=this._totalTime,k=this._startTime,A=this._timeScale,B=this._rawPrevTime,w=this._paused,p=this._cycle;if(a>=d?(this._locked||(this._totalTime=d,this._cycle=this._repeat),this._reversed||this._hasPausedChild()||(t=!0,m="onComplete",0!==this._duration||!(0===a||0>this._rawPrevTime))||this._rawPrevTime!==a&&(c=!0),this._rawPrevTime=a,this._yoyo&&0!==(1&this._cycle)?(this._time=0,a=-1e-6):(this._time=this._duration,a=this._duration+1e-6)):0>=a?(this._locked||(this._totalTime=this._cycle=0),this._time=0,(0!==f||0===this._duration&&0<this._rawPrevTime)&&(m="onReverseComplete",t=this._reversed),0>a?(this._active=!1,0===this._duration&&0<=this._rawPrevTime&&(c=!0)):this._initted||(c=!0),this._rawPrevTime=a,a=-1e-6):(this._time=this._rawPrevTime=a,this._locked||(this._totalTime=a,0===this._repeat)||(a=this._duration+this._repeatDelay,this._cycle=this._totalTime/a>>0,0!==this._cycle&&this._cycle===this._totalTime/a&&this._cycle--,this._time=this._totalTime-this._cycle*a,this._yoyo&&0!=(1&this._cycle)&&(this._time=this._duration-this._time),this._time>this._duration?(this._time=this._duration,a=this._duration+1e-6):0>this._time?(this._time=0,a=-1e-6):a=this._time)),this._cycle!==p&&!this._locked){var x=this._yoyo&&0!==(1&p),y=x===(this._yoyo&&0!==(1&this._cycle)),D=this._totalTime,C=this._cycle,E=this._rawPrevTime,q=this._time;this._totalTime=p*this._duration,this._cycle<p?x=!x:this._totalTime+=this._duration,this._time=f,this._rawPrevTime=B,this._cycle=p,this._locked=!0,f=x?0:this._duration,this.render(f,b,!1),b||this._gc||this.vars.onRepeat&&this.vars.onRepeat.apply(this.vars.onRepeatScope||this,vars.onRepeatParams||h),y&&(f=x?this._duration+1e-6:-1e-6,this.render(f,!0,!1)),this._time=q,this._totalTime=D,this._cycle=C,this._rawPrevTime=E,this._locked=!1}if(this._time!==f||c){if(this._initted||(this._initted=!0),0===g&&this.vars.onStart&&0!==this._totalTime&&(b||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||h)),this._time>f)for(c=this._first;c&&(g=c._next,!this._paused||w);)(c._active||c._startTime<=this._time&&!c._paused&&!c._gc)&&(c._reversed?c.render((c._dirty?c.totalDuration():c._totalDuration)-(a-c._startTime)*c._timeScale,b,!1):c.render((a-c._startTime)*c._timeScale,b,!1)),c=g;else for(c=this._last;c&&(g=c._prev,!this._paused||w);)(c._active||c._startTime<=f&&!c._paused&&!c._gc)&&(c._reversed?c.render((c._dirty?c.totalDuration():c._totalDuration)-(a-c._startTime)*c._timeScale,b,!1):c.render((a-c._startTime)*c._timeScale,b,!1)),c=g;this._onUpdate&&(b||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||h)),!m||this._locked||this._gc||k!==this._startTime&&A==this._timeScale||(0===this._time||d>=this.totalDuration())&&(t&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),b||this.vars[m]&&this.vars[m].apply(this.vars[m+"Scope"]||this,this.vars[m+"Params"]||h))}},d.getActive=function(a,c,e){null==a&&(a=!0),null==c&&(c=!0),null==e&&(e=!1);var d,h,f=[],a=this.getChildren(a,c,e),c=0,e=a.length;for(d=0;e>d;d++)if(h=a[d],!h._paused&&h._timeline._totalTime>=h._startTime&&h._timeline._totalTime<h._startTime+h._totalDuration/h._timeScale){var g;a:{for(g=h._timeline;g;){if(g._paused){g=!0;break a}g=g._timeline}g=!1}g||(f[c++]=h)}return f},d.getLabelAfter=function(a){!a&&0!==a&&(a=this._time);var f,c=this._getLabelsArray(),e=c.length;for(f=0;e>f;f++)if(c[f].time>a)return c[f].name;return null},d.getLabelBefore=function(a){null==a&&(a=this._time);for(var c=this._getLabelsArray(),f=c.length;-1<--f;)if(c[f].time<a)return c[f].name;return null},d._getLabelsArray=function(){var f,a=[],c=0;for(f in this._labels)a[c++]={time:this._labels[f],name:f};return a.sort(function(a,c){return a.time-c.time}),a},d.progress=function(a){return arguments.length?this.totalTime(this.duration()*a+this._cycle*this._duration,!1):this._time/this.duration()},d.totalProgress=function(a){return arguments.length?this.totalTime(this.totalDuration()*a,!1):this._totalTime/this.totalDuration()},d.totalDuration=function(a){return arguments.length?-1==this._repeat?this:this.duration((a-this._repeat*this._repeatDelay)/(this._repeat+1)):(this._dirty&&(g.prototype.totalDuration.call(this),this._totalDuration=-1===this._repeat?999999999999:this._duration*(this._repeat+1)+this._repeatDelay*this._repeat),this._totalDuration)
},d.time=function(a,c){return arguments.length?(this._dirty&&this.totalDuration(),a>this._duration&&(a=this._duration),this._yoyo&&0!==(1&this._cycle)?a=this._duration-a+this._cycle*(this._duration+this._repeatDelay):0!=this._repeat&&(a+=this._cycle*(this._duration+this._repeatDelay)),this.totalTime(a,c)):this._time},d.repeat=function(a){return arguments.length?(this._repeat=a,this._uncache(!0)):this._repeat},d.repeatDelay=function(a){return arguments.length?(this._repeatDelay=a,this._uncache(!0)):this._repeatDelay},d.yoyo=function(a){return arguments.length?(this._yoyo=a,this):this._yoyo},d.currentLabel=function(a){return arguments.length?this.seek(a,!0):this.getLabelBefore(this._time+1e-8)},f},!0),_gsDefine("plugins.CSSPlugin",["plugins.TweenPlugin","TweenLite"],function(g){var k=function(){g.call(this,"css"),this._overwriteProps.pop()},d=k.prototype=new g("css");d.constructor=k,k.API=2,k.suffixMap={top:"px",right:"px",bottom:"px",left:"px",width:"px",height:"px",fontSize:"px",padding:"px",margin:"px"};var F,f=/[^\d\-\.]/g,h=/(\d|\-|\+|=|#|\.)*/g,c=/\d+/g,a=/opacity=([^)]*)/,b=/opacity:([^;]*)/,e=/([A-Z])/g,l=/-([a-z])/gi,j=function(i,a){return a.toUpperCase()},u=/(Left|Right|width|Width)/,z=/(M11|M12|M21|M22)=[\d\-\.e]+/gi,A=/progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i,B=Math.PI/180,w=180/Math.PI,p=document.createElement("div"),t=function(){var a,i=document.createElement("div");return i.innerHTML="<a style='top:1px;opacity:.55;'>a</a>",(a=i.getElementsByTagName("a")[0])?/^0.55/.test(a.style.opacity):!1}(),m=function(i){return i&&""!==i?r[i]?r[i]:"#"===i.charAt(0)?(4===i.length&&(i="#"+i.charAt(1)+i.charAt(1)+i.charAt(2)+i.charAt(2)+i.charAt(3)+i.charAt(3)),i=parseInt(i.substr(1),16),[i>>16,i>>8&255,255&i]):i.match(c)||r.transparent:r.black},x=function(i){return a.test("string"==typeof i?i:(i.currentStyle?i.currentStyle.filter:i.style.filter)||"")?parseFloat(RegExp.$1)/100:1},y=document.defaultView?document.defaultView.getComputedStyle:function(){},D=function(i,a,c,b){return t||"opacity"!==a?!b&&i.style[a]?i.style[a]:(c=c||y(i,null))?(i=c.getPropertyValue(a.replace(e,"-$1").toLowerCase()))||c.length?i:c[a]:i.currentStyle?i.currentStyle[a]:null:x(i)},C=function(i,a){var b,c={};if(a=a||y(i,null))if(b=a.length)for(;-1<--b;)c[a[b].replace(l,j)]=a.getPropertyValue(a[b]);else for(b in a)c[b]=a[b];else if(a=i.currentStyle||i.style)for(b in a)c[b.replace(l,j)]=a[b];return t||(c.opacity=x(i)),b=G(i,a,!1),c.rotation=b.rotation*w,c.skewX=b.skewX*w,c.scaleX=b.scaleX,c.scaleY=b.scaleY,c.x=b.x,c.y=b.y,null!=c.filters&&delete c.filters,c},E=function(i,a,c,b){var s,q,n={};for(q in a)"cssText"!==q&&"length"!==q&&isNaN(q)&&s!==v&&i[q]!=(s=a[q])&&("number"==typeof s||"string"==typeof s)&&(n[q]=s,b&&b.props.push(q));if(c)for(q in c)"className"!==q&&(n[q]=c[q]);return n},q={scaleX:1,scaleY:1,x:1,y:1,rotation:1,shortRotation:1,skewX:1,skewY:1,scale:1},v=function(){for(var i=document.body||document.documentElement,a=y(i,""),c="O -o- Moz -moz- ms -ms- Webkit -webkit-".split(" "),b=9;-1<(b-=2)&&!D(i,c[b]+"transform",a););return b>0?(F=c[b]+"transform",c[b-1]+"Transform"):null}(),G=function(i,a,c){var b;v?b=D(i,F,a,!0):i.currentStyle&&(b=(b=i.currentStyle.filter.match(z))&&4===b.length?b[0].substr(4)+","+Number(b[2].substr(4))+","+Number(b[1].substr(4))+","+b[3].substr(4)+",0,0":null);var a=(b||"").replace(/[^\d\-\.e,]/g,"").split(","),n=(b=6<=a.length)?Number(a[0]):1,s=b?Number(a[1]):0,q=b?Number(a[2]):0,f=b?Number(a[3]):1,d=c?i._gsTransform||{skewY:0}:{skewY:0},e=0>d.scaleX;return d.x=b?Number(a[4]):0,d.y=b?Number(a[5]):0,d.rotation=Math.atan2(s,n),d.scaleX=Math.sqrt(n*n+s*s),d.scaleY=Math.sqrt(f*f+q*q),d.skewX=Math.atan2(q,f)+d.rotation,(0>n&&f>=0||n>0&&0>=f)&&(e?(d.scaleX*=-1,d.skewX+=0>=d.rotation?Math.PI:-Math.PI,d.rotation+=0>=d.rotation?Math.PI:-Math.PI):(d.scaleY*=-1,d.skewX+=0>=d.skewX?Math.PI:-Math.PI)),1e-8>d.rotation&&-1e-8<d.rotation&&(d.rotation=0),1e-8>d.skewX&&-1e-8<d.skewX&&(d.skewX=0),c&&(i._gsTransform=d),d},I={width:["Left","Right"],height:["Top","Bottom"]},H=["marginLeft","marginRight","marginTop","marginBottom"],i=function(a,c,b,n,s){if("px"===n)return b;if("auto"===n)return 0;var q=u.test(c),d=a;return p.style.cssText="border-style:solid; border-width:0; position:absolute; line-height:0;","%"===n||"em"===n?(d=a.parentNode||document.body,p.style[q?"width":"height"]=b+n):p.style[q?"borderLeftWidth":"borderTopWidth"]=b+n,d.appendChild(p),q=parseFloat(p[q?"offsetWidth":"offsetHeight"]),d.removeChild(p),0===q&&!s&&(q=i(a,c,b,n,!0)),q},s=function(i,a){(null==i||""===i||"auto"===i)&&(i="0 0");var a=a||{},c=-1!==i.indexOf("left")?"0%":-1!==i.indexOf("right")?"100%":i.split(" ")[0],b=-1!==i.indexOf("top")?"0%":-1!==i.indexOf("bottom")?"100%":i.split(" ")[1];return null==b?b="0":"center"===b&&(b="50%"),"center"===c&&(c="50%"),a.oxp=-1!==c.indexOf("%"),a.oyp=-1!==b.indexOf("%"),a.oxr="="===c.charAt(1),a.oyr="="===b.charAt(1),a.ox=parseFloat(c.replace(f,"")),a.oy=parseFloat(b.replace(f,"")),a},n=function(i,a){return null==i?a:"string"==typeof i&&1===i.indexOf("=")?Number(i.split("=").join(""))+a:Number(i)},o=function(i,a){var c=-1===i.indexOf("rad")?B:1,b=1===i.indexOf("="),i=Number(i.replace(f,""))*c;return b?i+a:i},r={aqua:[0,255,255],lime:[0,255,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,255],navy:[0,0,128],white:[255,255,255],fuchsia:[255,0,255],olive:[128,128,0],yellow:[255,255,0],orange:[255,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[255,0,0],pink:[255,192,203],cyan:[0,255,255],transparent:[255,255,255,0]};return d._onInitTween=function(i,a,c){if(!i.nodeType)return!1;this._target=i,this._tween=c,this._classData=this._transform=null;var s,q,c=this._style=i.style,n=y(i,"");return"string"==typeof a?(s=c.cssText,q=C(i,n),c.cssText=s+";"+a,q=E(q,C(i)),!t&&b.test(a)&&(val.opacity=parseFloat(RegExp.$1)),a=q,c.cssText=s):a.className&&(s=i.className,q=C(i,n),i.className="="!==a.className.charAt(1)?a.className:"+"===a.className.charAt(0)?i.className+" "+a.className.substr(2):i.className.split(a.className.substr(2)).join(""),a=E(q,C(i),a,this._classData={b:s,e:i.className,props:[]}),i.className=s),this._parseVars(a,i,n,a.suffixMap||k.suffixMap),!0},d._parseVars=function(a,c,b,n){var e,o,g,r,k,l,j,d=this._style;for(e in a)if(o=a[e],"transform"===e||e===v)this._parseTransform(c,o,b,n);else if(q[e]||"transformOrigin"===e)this._parseTransform(c,a,b,n);else{if("alpha"===e||"autoAlpha"===e)e="opacity";else{if("margin"===e||"padding"===e){o=(o+"").split(" "),r=o.length,g={},g[e+"Top"]=o[0],g[e+"Right"]=r>1?o[1]:o[0],g[e+"Bottom"]=4===r?o[2]:o[0],g[e+"Left"]=4===r?o[3]:2===r?o[1]:o[0],this._parseVars(g,c,b,n);continue}if("backgroundPosition"===e||"backgroundSize"===e){g=s(o),j=s(r=D(c,e,b)),this._firstPT=g={_next:this._firstPT,t:d,p:e,b:r,f:!1,n:"css_"+e,type:3,s:j.ox,c:g.oxr?g.ox:g.ox-j.ox,ys:j.oy,yc:g.oyr?g.oy:g.oy-j.oy,sfx:g.oxp?"%":"px",ysfx:g.oyp?"%":"px",r:!g.oxp&&!1!==a.autoRound},g.e=g.s+g.c+g.sfx+" "+(g.ys+g.yc)+g.ysfx;continue}if("border"===e){o=(o+"").split(" "),this._parseVars({borderWidth:o[0],borderStyle:o[1]||"none",borderColor:o[2]||"#000000"},c,b,n);continue}if("autoRound"===e)continue}if(r=D(c,e,b),r=null!=r?r+"":"",this._firstPT=g={_next:this._firstPT,t:d,p:e,b:r,f:!1,n:"css_"+e,sfx:"",r:!1,type:0},"opacity"===e&&null!=a.autoAlpha&&(this._firstPT=g._prev={_next:g,t:d,p:"visibility",f:!1,n:"css_visibility",r:!1,type:-1,b:0!==Number(r)?"visible":"hidden",i:"visible",e:0===Number(o)?"hidden":"visible"},this._overwriteProps.push("css_visibility")),"color"===e||"fill"===e||"stroke"===e||-1!==e.indexOf("Color")||"string"==typeof o&&!o.indexOf("rgb("))k=m(r),r=m(o),g.e=o,g.s=Number(k[0]),g.c=Number(r[0])-g.s,g.gs=Number(k[1]),g.gc=Number(r[1])-g.gs,g.bs=Number(k[2]),g.bc=Number(r[2])-g.bs,3<k.length||3<r.length?(g.as=4>k.length?1:Number(k[3]),g.ac=(4>r.length?1:Number(r[3]))-g.as,g.type=g.c||g.gc||g.bc||g.ac?2:-1):g.type=g.c||g.gc||g.bc?1:-1;else{if(k=r.replace(h,""),""===r||"auto"===r)if("width"===e||"height"===e){l=e,k=c,r=b,j=parseFloat("width"===l?k.offsetWidth:k.offsetHeight),l=I[l];var p=l.length;for(r=r||y(k,null);-1<--p;)j-=parseFloat(D(k,"padding"+l[p],r,!0))||0,j-=parseFloat(D(k,"border"+l[p]+"Width",r,!0))||0;k="px"}else j="opacity"!==e?0:1;else j=-1===r.indexOf(" ")?parseFloat(r.replace(f,"")):0/0;"string"==typeof o?(r="="===o.charAt(1),l=o.replace(h,""),o=-1===o.indexOf(" ")?parseFloat(o.replace(f,"")):0/0):(r=!1,l=""),""===l&&(l=n[e]||k),g.e=o||0===o?(r?o+j:o)+l:a[e],k===l||""===l||!o&&0!==o||(j||0===j)&&(j=i(c,e,j,k),"%"===l?(j/=i(c,e,100,"%")/100,j>100&&(j=100)):"em"===l?j/=i(c,e,1,"em"):(o=i(c,e,o,l),l="px"),r&&(o||0===o)&&(g.e=o+j+l)),!j&&0!==j||!o&&0!==o||!(g.c=r?o:o-j)?(g.type=-1,g.i=g.e,g.s=g.c=0):(g.s=j,g.sfx=l,"opacity"===e?t||(g.type=4,g.p="filter",g.b="alpha(opacity="+100*g.s+")",g.e="alpha(opacity="+100*(g.s+g.c)+")",g.dup=null!=a.autoAlpha,this._style.zoom=1):!1===a.autoRound||"px"!==l&&"zIndex"!==e||(g.r=!0))}this._overwriteProps.push("css_"+e),g._next&&(g._next._prev=g)}},d._parseTransform=function(i,a,c){if(!this._transform){var e,d,c=this._transform=G(i,c,!0),b=this._style;if("object"==typeof a)i={scaleX:n(null!=a.scaleX?a.scaleX:a.scale,c.scaleX),scaleY:n(null!=a.scaleY?a.scaleY:a.scale,c.scaleY),x:n(a.x,c.x),y:n(a.y,c.y)},null!=a.shortRotation?(i.rotation="number"==typeof a.shortRotation?a.shortRotation*B:o(a.shortRotation,c.rotation),e=(i.rotation-c.rotation)%(2*Math.PI),e!==e%Math.PI&&(e+=Math.PI*(0>e?2:-2)),i.rotation=c.rotation+e):i.rotation=null==a.rotation?c.rotation:"number"==typeof a.rotation?a.rotation*B:o(a.rotation,c.rotation),i.skewX=null==a.skewX?c.skewX:"number"==typeof a.skewX?a.skewX*B:o(a.skewX,c.skewX),i.skewY=null==a.skewY?c.skewY:"number"==typeof a.skewY?a.skewY*B:o(a.skewY,c.skewY),(e=i.skewY-c.skewY)&&(i.skewX+=e,i.rotation+=e),null!=(a=a.transformOrigin)&&(v?(d=v+"Origin",this._firstPT=a={_next:this._firstPT,t:b,p:d,s:0,c:0,n:d,f:!1,r:!1,b:b[d],e:a,i:a,type:-1,sfx:""},a._next&&(a._next._prev=a)):s(a,c));else{if("string"!=typeof a||!v)return;e=b[v],b[v]=a,i=G(i,null,!1),b[v]=e}v?"WebkitTransform"===v&&(b[v+"Style"]="preserve-3d"):b.zoom=1;for(d in q)c[d]!==i[d]&&"shortRotation"!==d&&"scale"!==d&&(this._firstPT=a={_next:this._firstPT,t:c,p:d,s:c[d],c:i[d]-c[d],n:d,f:!1,r:!1,b:c[d],e:i[d],type:0,sfx:0},a._next&&(a._next._prev=a),this._overwriteProps.push("css_"+d))}},d.setRatio=function(c){var n,s,b=this._firstPT;if(1!==c||this._tween._time!==this._tween._duration&&0!==this._tween._time)if(c||this._tween._time!==this._tween._duration&&0!==this._tween._time)for(;b;)n=b.c*c+b.s,b.r&&(n=n>0?n+.5>>0:n-.5>>0),b.type?1===b.type?b.t[b.p]="rgb("+(n>>0)+", "+(b.gs+c*b.gc>>0)+", "+(b.bs+c*b.bc>>0)+")":2===b.type?b.t[b.p]="rgba("+(n>>0)+", "+(b.gs+c*b.gc>>0)+", "+(b.bs+c*b.bc>>0)+", "+(b.as+c*b.ac)+")":-1===b.type?b.t[b.p]=b.i:3===b.type?(s=b.ys+c*b.yc,b.r&&(s=s>0?s+.5>>0:s-.5>>0),b.t[b.p]=n+b.sfx+" "+s+b.ysfx):(b.dup&&(b.t.filter=b.t.filter||"alpha(opacity=100)"),b.t.filter=-1===b.t.filter.indexOf("opacity=")?b.t.filter+(" alpha(opacity="+(100*n>>0)+")"):b.t.filter.replace(a,"opacity="+(100*n>>0))):b.t[b.p]=n+b.sfx,b=b._next;else for(;b;)b.t[b.p]=b.b,4===b.type&&1===b.s&&this._style.removeAttribute("filter"),b=b._next;else for(;b;)b.t[b.p]=b.e,4===b.type&&1===b.s+b.c&&this._style.removeAttribute("filter"),b=b._next;if(this._transform)if(b=this._transform,v&&!b.rotation)this._style[v]=(b.x||b.y?"translate("+b.x+"px,"+b.y+"px) ":"")+(b.skewX?"skewX("+b.skewX+"rad) ":"")+(1!==b.scaleX||1!==b.scaleY?"scale("+b.scaleX+","+Math.cos(b.skewX)*b.scaleY+")":"")||"translate(0px,0px)";else{var d=v?b.rotation:-b.rotation,e=v?d-b.skewX:d+b.skewX;s=Math.cos(d)*b.scaleX;var g,d=Math.sin(d)*b.scaleX,q=Math.sin(e)*-b.scaleY,e=Math.cos(e)*b.scaleY,f=1e-8;if(f>d&&d>-f&&(d=0),f>q&&q>-f&&(q=0),v)this._style[v]="matrix("+s+","+d+","+q+","+e+","+b.x+","+b.y+")";else if(g=this._target.currentStyle){f=d,d=-q,q=-f,f=this._style.filter,this._style.filter="",n=this._target.offsetWidth;var m,p,o=this._target.offsetHeight,r="absolute"!==g.position,k="progid:DXImageTransform.Microsoft.Matrix(M11="+s+", M12="+d+", M21="+q+", M22="+e,l=b.x,j=b.y;if(null!=b.ox&&(m=(b.oxp?.01*n*b.ox:b.ox)-n/2,p=(b.oyp?.01*o*b.oy:b.oy)-o/2,l=m-(m*s+p*d)+b.x,j=p-(m*q+p*e)+b.y),r)m=n/2,p=o/2,k+=", Dx="+(m-(m*s+p*d)+l)+", Dy="+(p-(m*q+p*e)+j)+")";else{for(r=4,m=b.ieOffsetX||0,p=b.ieOffsetY||0,b.ieOffsetX=Math.round((n-((0>s?-s:s)*n+(0>d?-d:d)*o))/2+l),b.ieOffsetY=Math.round((o-((0>e?-e:e)*o+(0>q?-q:q)*n))/2+j);-1<--r;)o=H[r],n=g[o],n=-1!==n.indexOf("px")?parseFloat(n):i(this._target,o,parseFloat(n),n.replace(h,""))||0,this._style[o]=Math.round(n-(2>r?m-b.ieOffsetX:p-b.ieOffsetY))+"px";k+=",sizingMethod='auto expand')"}this._style.filter=-1!==f.indexOf("progid:DXImageTransform.Microsoft.Matrix(")?f.replace(A,k):f+" "+k,!(0!==c&&1!==c||1!==s||0!==d||0!==q||1!==e||a.test(f)&&100!==parseFloat(RegExp.$1)||!this._style.removeAttribute("filter"))}}if(this._classData)if(b=this._classData,1!==c||this._tween._time!==this._tween._duration&&0!==this._tween._time)this._target.className!==b.b&&(this._target.className=b.b);else{for(r=b.props.length;-1<--r;)this._style[b.props[r]]="";this._target.className=b.e}},d._kill=function(a){var b,i=a;if(a.autoAlpha||a.alpha){i={};for(b in a)i[b]=a[b];i.opacity=1,i.autoAlpha&&(i.visibility=1)}return g.prototype._kill.call(this,i)},g.activate([k]),k},!0),_gsDefine("plugins.RoundPropsPlugin",["plugins.TweenPlugin"],function(g){var k=function(){g.call(this,"roundProps",-1),this._overwriteProps.pop()},d=k.prototype=new g("roundProps",-1);return d.constructor=k,k.API=2,d._onInitTween=function(d,g,c){return this._tween=c,!0},d._onInitAllProps=function(){for(var a,b,d=this._tween.vars.roundProps instanceof Array?this._tween.vars.roundProps:this._tween.vars.roundProps.split(","),g=d.length,c={};-1<--g;)c[d[g]]=1;for(g=d.length;-1<--g;)for(a=d[g],b=this._tween._firstPT;b;)b.pg?b.t._roundProps(c,!0):b.n==a&&(this._add(b.t,a,b.s,b.c),b._next&&(b._next._prev=b._prev),b._prev?b._prev._next=b._next:_tween._firstPT===b&&(this._tween._firstPT=b._next),b._next=b._prev=null,this._tween._propLookup[a]=this),b=b._next;return!1},d._add=function(d,g,c,a){this._addTween(d,g,c,c+a,g,!0),this._overwriteProps.push(g)},g.activate([k]),k},!0),_gsDefine("easing.Back",["easing.Ease"],function(g){var k=window.com.greensock._class,d=function(a,b){var c=k("easing."+a,function(){},!0),d=c.prototype=new g;return d.constructor=c,d.getRatio=b,c},f=function(a,b){var c=k("easing."+a,function(a){this._p1=a||0===a?a:1.70158,this._p2=1.525*this._p1},!0),d=c.prototype=new g;return d.constructor=c,d.getRatio=b,d.config=function(a){return new c(a)},c},h=f("BackOut",function(a){return(a-=1)*a*((this._p1+1)*a+this._p1)+1}),c=f("BackIn",function(a){return a*a*((this._p1+1)*a-this._p1)}),f=f("BackInOut",function(a){return 1>(a*=2)?.5*a*a*((this._p2+1)*a-this._p2):.5*((a-=2)*a*((this._p2+1)*a+this._p2)+2)}),a=d("BounceOut",function(a){return 1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375}),b=d("BounceIn",function(a){return(a=1-a)<1/2.75?1-7.5625*a*a:2/2.75>a?1-(7.5625*(a-=1.5/2.75)*a+.75):2.5/2.75>a?1-(7.5625*(a-=2.25/2.75)*a+.9375):1-(7.5625*(a-=2.625/2.75)*a+.984375)}),e=d("BounceInOut",function(a){var b=.5>a,a=b?1-2*a:2*a-1,a=1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375;return b?.5*(1-a):.5*a+.5}),l=d("CircOut",function(a){return Math.sqrt(1-(a-=1)*a)}),j=d("CircIn",function(a){return-(Math.sqrt(1-a*a)-1)}),u=d("CircInOut",function(a){return 1>(a*=2)?-.5*(Math.sqrt(1-a*a)-1):.5*(Math.sqrt(1-(a-=2)*a)+1)}),z=2*Math.PI,A=function(a,b,c){var d=k("easing."+a,function(a,b){a=a||0,this._p1=!a||1>a?1:a,this._p2=b||c,this._p3=this._p2/z*Math.asin(1/this._p1)},!0),a=d.prototype=new g;return a.constructor=d,a.getRatio=b,a.config=function(a,b){return new d(a,b)},d},B=A("ElasticOut",function(a){return this._p1*Math.pow(2,-10*a)*Math.sin((a-this._p3)*z/this._p2)+1},.3),w=A("ElasticIn",function(a){return-(this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*z/this._p2))},.3),A=A("ElasticInOut",function(a){return 1>(a*=2)?-.5*this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*z/this._p2):.5*this._p1*Math.pow(2,-10*(a-=1))*Math.sin((a-this._p3)*z/this._p2)+1},.45),p=d("ExpoOut",function(a){return 1-Math.pow(2,-10*a)}),t=d("ExpoIn",function(a){return Math.pow(2,10*(a-1))-.001}),m=d("ExpoInOut",function(a){return 1>(a*=2)?.5*Math.pow(2,10*(a-1)):.5*(2-Math.pow(2,-10*(a-1)))}),x=Math.PI/2,y=d("SineOut",function(a){return Math.sin(a*x)}),D=d("SineIn",function(a){return-Math.cos(a*x)+1}),d=d("SineInOut",function(a){return-.5*(Math.cos(Math.PI*a)-1)}),C=k("easing.SlowMo",function(a,b,c){null==a?a=.7:a>1&&(a=1),this._p=1!=a?b||0===b?b:.7:0,this._p1=(1-a)/2,this._p2=a,this._p3=this._p1+this._p2,this._calcEnd=1==c},!0),E=C.prototype=new g;return E.constructor=C,E.getRatio=function(a){var b=a+(.5-a)*this._p;return a<this._p1?this._calcEnd?1-(a=1-a/this._p1)*a:b-(a=1-a/this._p1)*a*a*a*b:a>this._p3?this._calcEnd?1-(a=(a-this._p3)/this._p1)*a:b+(a-b)*(a=(a-this._p3)/this._p1)*a*a*a:this._calcEnd?1:b},C.ease=new C(.7,.7),E.config=function(a,b,c){return new C(a,b,c)},k("easing.Bounce",{easeOut:new a,easeIn:new b,easeInOut:new e},!0),k("easing.Circ",{easeOut:new l,easeIn:new j,easeInOut:new u},!0),k("easing.Elastic",{easeOut:new B,easeIn:new w,easeInOut:new A},!0),k("easing.Expo",{easeOut:new p,easeIn:new t,easeInOut:new m},!0),k("easing.Sine",{easeOut:new y,easeIn:new D,easeInOut:new d},!0),{easeOut:new h,easeIn:new c,easeInOut:new f}},!0)}),function(g){var f,h,c,a,k=function(a){var c,a=a.split("."),b=g;for(c=0;c<a.length;c++)b[a[c]]=b=b[a[c]]||{};return b},d=k("com.greensock"),b={},e=function(a,c,n,d){this.sc=b[a]?b[a].sc:[],b[a]=this,this.gsClass=null,this.def=n;var f=c||[],h=[];this.check=function(c){for(var j,s=f.length,l=0;-1<--s;)(j=b[f[s]]||new e(f[s])).gsClass?h[s]=j.gsClass:(l++,c&&j.sc.push(this));if(0===l&&n){var c=("com.greensock."+a).split("."),s=c.pop(),m=k(c.join("."))[s]=this.gsClass=n.apply(n,h);for(d&&((g.GreenSockGlobals||g)[s]=m,"function"==typeof define&&define.amd?define((g.GreenSockAMDPath?g.GreenSockAMDPath+"/":"")+a.split(".").join("/"),[],function(){return m}):"undefined"!=typeof module&&module.exports&&(module.exports=m)),s=0;s<this.sc.length;s++)this.sc[s].check(!1)}},this.check(!0)},l=d._class=function(a,b,c){return new e(a,[],function(){return b},c),b};g._gsDefine=function(a,b,c,d){return new e(a,b,c,d)};var j=[0,0,1,1],u=[],z=l("easing.Ease",function(a,b,c,d){this._func=a,this._type=c||0,this._power=d||0,this._params=b?j.concat(b):j},!0);for(c=z.prototype,c._calcEnd=!1,c.getRatio=function(a){if(this._func)return this._params[0]=a,this._func.apply(null,this._params);var b=this._type,c=this._power,d=1===b?1-a:2===b?a:.5>a?2*a:2*(1-a);return 1===c?d*=d:2===c?d*=d*d:3===c?d*=d*d*d:4===c&&(d*=d*d*d*d),1===b?1-d:2===b?d:.5>a?d/2:1-d/2},f=["Linear","Quad","Cubic","Quart","Quint"],h=f.length;-1<--h;)c=l("easing."+f[h],function(){},!0),a=l("easing.Power"+h,function(){},!0),c.easeOut=a.easeOut=new z(null,null,1,h),c.easeIn=a.easeIn=new z(null,null,2,h),c.easeInOut=a.easeInOut=new z(null,null,3,h);l("easing.Strong",d.easing.Power4,!0),d.easing.Linear.easeNone=d.easing.Linear.easeIn,c=l("events.EventDispatcher",function(a){this._listeners={},this._eventTarget=a||this}).prototype,c.addEventListener=function(a,b,c,d,e){var h,e=e||0,g=this._listeners[a],f=0;for(null==g&&(this._listeners[a]=g=[]),h=g.length;-1<--h;)a=g[h],a.c===b?g.splice(h,1):0===f&&a.pr<e&&(f=h+1);g.splice(f,0,{c:b,s:c,up:d,pr:e})},c.removeEventListener=function(a,b){var c=this._listeners[a];if(c)for(var d=c.length;-1<--d;)if(c[d].c===b){c.splice(d,1);break}},c.dispatchEvent=function(a){var b=this._listeners[a];if(b)for(var d,c=b.length,e=this._eventTarget;-1<--c;)d=b[c],d.up?d.c.call(d.s||e,{type:a,target:e}):d.c.call(d.s||e)};var A=g.requestAnimationFrame,B=g.cancelAnimationFrame,w=Date.now||function(){return(new Date).getTime()};for(f=["ms","moz","webkit","o"],h=f.length;-1<--h&&!A;)A=g[f[h]+"RequestAnimationFrame"],B=g[f[h]+"CancelAnimationFrame"]||g[f[h]+"CancelRequestAnimationFrame"];B||(B=function(a){g.clearTimeout(a)}),l("Ticker",function(a,b){this.frame=this.time=0;var f,h,k,l,j,c=this,d=w(),e=!1!==b;this.tick=function(){c.time=(w()-d)/1e3,(!f||c.time>=j)&&(c.frame++,j=c.time+l-(c.time-j)-5e-4,j<=c.time&&(j=c.time+.001),c.dispatchEvent("tick")),k=h(c.tick)},this.fps=function(a){return arguments.length?(f=a,l=1/(f||60),j=this.time+l,h=0===f?function(){}:e&&A?A:function(a){return g.setTimeout(a,1e3*(j-c.time)+1>>0||1)},B(k),void(k=h(c.tick))):f},this.useRAF=function(a){return arguments.length?(e=a,void this.fps(f)):e},this.fps(a)}),c=d.Ticker.prototype=new d.events.EventDispatcher,c.constructor=d.Ticker;var p=l("core.Animation",function(a,b){if(this.vars=b||{},this._duration=this._totalDuration=a||0,this._delay=Number(this.vars.delay)||0,this._timeScale=1,this._active=1==this.vars.immediateRender,this.data=this.vars.data,this._reversed=1==this.vars.reversed,F){var c=this.vars.useFrames?q:F;c.insert(this,c._time),this.vars.paused&&this.paused(!0)}}),t=p.ticker=new d.Ticker;c=p.prototype,c._dirty=c._gc=c._initted=c._paused=!1,c._totalTime=c._time=0,c._rawPrevTime=-1,c._next=c._last=c._onUpdate=c._timeline=c.timeline=null,c._paused=!1,c.play=function(a,b){return arguments.length&&this.seek(a,b),this.reversed(!1),this.paused(!1)},c.pause=function(a,b){return arguments.length&&this.seek(a,b),this.paused(!0)},c.resume=function(a,b){return arguments.length&&this.seek(a,b),this.paused(!1)},c.seek=function(a,b){return this.totalTime(Number(a),0!=b)},c.restart=function(a,b){return this.reversed(!1),this.paused(!1),this.totalTime(a?-this._delay:0,0!=b)},c.reverse=function(a,b){return arguments.length&&this.seek(a||this.totalDuration(),b),this.reversed(!0),this.paused(!1)},c.render=function(){},c.invalidate=function(){return this},c._enabled=function(a,b){return this._gc=!a,this._active=a&&!this._paused&&0<this._totalTime&&this._totalTime<this._totalDuration,1!=b&&(a&&null==this.timeline?this._timeline.insert(this,this._startTime-this._delay):!a&&null!=this.timeline&&this._timeline._remove(this,!0)),!1},c._kill=function(){return this._enabled(!1,!1)},c.kill=function(a,b){return this._kill(a,b),this},c._uncache=function(a){for(a=a?this:this.timeline;a;)a._dirty=!0,a=a.timeline;return this},c.eventCallback=function(a,b,c,d){if(null==a)return null;if("on"===a.substr(0,2)){if(1===arguments.length)return this.vars[a];if(null==b)delete this.vars[a];else if(this.vars[a]=b,this.vars[a+"Params"]=c,this.vars[a+"Scope"]=d,c)for(var e=c.length;-1<--e;)"{self}"===c[e]&&(c=this.vars[a+"Params"]=c.concat(),c[e]=this);"onUpdate"===a&&(this._onUpdate=b)}return this},c.delay=function(a){return arguments.length?(this._timeline.smoothChildTiming&&this.startTime(this._startTime+a-this._delay),this._delay=a,this):this._delay},c.duration=function(a){return arguments.length?(this._duration=this._totalDuration=a,this._uncache(!0),this._timeline.smoothChildTiming&&this._active&&0!=a&&this.totalTime(this._totalTime*(a/this._duration),!0),this):(this._dirty=!1,this._duration)},c.totalDuration=function(a){return this._dirty=!1,arguments.length?this.duration(a):this._totalDuration},c.time=function(a,b){return arguments.length?(this._dirty&&this.totalDuration(),a>this._duration&&(a=this._duration),this.totalTime(a,b)):this._time},c.totalTime=function(a,b){if(!arguments.length)return this._totalTime;if(this._timeline){if(0>a&&(a+=this.totalDuration()),this._timeline.smoothChildTiming&&(this._dirty&&this.totalDuration(),a>this._totalDuration&&(a=this._totalDuration),this._startTime=(this._paused?this._pauseTime:this._timeline._time)-(this._reversed?this._totalDuration-a:a)/this._timeScale,this._timeline._dirty||this._uncache(!1),!this._timeline._active))for(var c=this._timeline;c._timeline;)c.totalTime(c._totalTime,!0),c=c._timeline;this._gc&&this._enabled(!0,!1),this._totalTime!=a&&this.render(a,b,!1)}return this},c.startTime=function(a){return arguments.length?(a!=this._startTime&&(this._startTime=a,this.timeline&&this.timeline._sortChildren&&this.timeline.insert(this,a-this._delay)),this):this._startTime},c.timeScale=function(a){if(!arguments.length)return this._timeScale;if(a=a||1e-6,this._timeline&&this._timeline.smoothChildTiming){var b=this._pauseTime||0==this._pauseTime?this._pauseTime:this._timeline._totalTime;this._startTime=b-(b-this._startTime)*this._timeScale/a}return this._timeScale=a,this._uncache(!1)},c.reversed=function(a){return arguments.length?(a!=this._reversed&&(this._reversed=a,this.totalTime(this._totalTime,!0)),this):this._reversed},c.paused=function(a){return arguments.length?(a!=this._paused&&this._timeline&&(!a&&this._timeline.smoothChildTiming&&(this._startTime+=this._timeline.rawTime()-this._pauseTime,this._uncache(!1)),this._pauseTime=a?this._timeline.rawTime():null,this._paused=a,this._active=!this._paused&&0<this._totalTime&&this._totalTime<this._totalDuration),this._gc&&(a||this._enabled(!0,!1)),this):this._paused},d=l("core.SimpleTimeline",function(a){p.call(this,0,a),this.autoRemoveChildren=this.smoothChildTiming=!0}),c=d.prototype=new p,c.constructor=d,c.kill()._gc=!1,c._first=c._last=null,c._sortChildren=!1,c.insert=function(a,b){a._startTime=Number(b||0)+a._delay,a._paused&&this!==a._timeline&&(a._pauseTime=a._startTime+(this.rawTime()-a._startTime)/a._timeScale),a.timeline&&a.timeline._remove(a,!0),a.timeline=a._timeline=this,a._gc&&a._enabled(!0,!0);var c=this._last;if(this._sortChildren)for(var d=a._startTime;c&&c._startTime>d;)c=c._prev;return c?(a._next=c._next,c._next=a):(a._next=this._first,this._first=a),a._next?a._next._prev=a:this._last=a,a._prev=c,this._timeline&&this._uncache(!0),this},c._remove=function(a,b){return a.timeline===this&&(b||a._enabled(!1,!0),a.timeline=null,a._prev?a._prev._next=a._next:this._first===a&&(this._first=a._next),a._next?a._next._prev=a._prev:this._last===a&&(this._last=a._prev),this._timeline&&this._uncache(!0)),this},c.render=function(a,b){var d,c=this._first;for(this._totalTime=this._time=this._rawPrevTime=a;c;)d=c._next,(c._active||a>=c._startTime&&!c._paused)&&(c._reversed?c.render((c._dirty?c.totalDuration():c._totalDuration)-(a-c._startTime)*c._timeScale,b,!1):c.render((a-c._startTime)*c._timeScale,b,!1)),c=d},c.rawTime=function(){return this._totalTime};var m=l("TweenLite",function(a,b,c){if(p.call(this,b,c),null==a)throw"Cannot tween an undefined reference.";if(this.target=a,this._overwrite=null==this.vars.overwrite?E[m.defaultOverwrite]:"number"==typeof this.vars.overwrite?this.vars.overwrite>>0:E[this.vars.overwrite],(a instanceof Array||a.jquery)&&"object"==typeof a[0])for(this._targets=a.slice(0),this._propLookup=[],this._siblings=[],a=0;a<this._targets.length;a++)c=this._targets[a],c.jquery?(this._targets.splice(a--,1),this._targets=this._targets.concat(c.constructor.makeArray(c))):(this._siblings[a]=v(c,this,!1),1===this._overwrite&&1<this._siblings[a].length&&G(c,this,null,1,this._siblings[a]));else this._propLookup={},this._siblings=v(a,this,!1),1===this._overwrite&&1<this._siblings.length&&G(a,this,null,1,this._siblings);(this.vars.immediateRender||0===b&&0===this._delay&&0!=this.vars.immediateRender)&&this.render(0,!1,!0)},!0);c=m.prototype=new p,c.constructor=m,c.kill()._gc=!1,c.ratio=0,c._firstPT=c._targets=c._overwrittenProps=null,c._notifyPluginsOfEnabled=!1,m.version=12,m.defaultEase=c._ease=new z(null,null,1,1),m.defaultOverwrite="auto",m.ticker=t;var x=m._plugins={},y={},D=0,C={ease:1,delay:1,overwrite:1,onComplete:1,onCompleteParams:1,onCompleteScope:1,useFrames:1,runBackwards:1,startAt:1,onUpdate:1,onUpdateParams:1,onUpdateScope:1,onStart:1,onStartParams:1,onStartScope:1,onReverseComplete:1,onReverseCompleteParams:1,onReverseCompleteScope:1,onRepeat:1,onRepeatParams:1,onRepeatScope:1,easeParams:1,yoyo:1,orientToBezier:1,immediateRender:1,repeat:1,repeatDelay:1,data:1,paused:1,reversed:1},E={none:0,all:1,auto:2,concurrent:3,allOnStart:4,preexisting:5,"true":1,"false":0},q=p._rootFramesTimeline=new d,F=p._rootTimeline=new d;F._startTime=t.time,q._startTime=t.frame,F._active=q._active=!0,p._updateRoot=function(){if(F.render((t.time-F._startTime)*F._timeScale,!1,!1),q.render((t.frame-q._startTime)*q._timeScale,!1,!1),!(t.frame%120)){var a,b,c;for(c in y){for(b=y[c].tweens,a=b.length;-1<--a;)b[a]._gc&&b.splice(a,1);0===b.length&&delete y[c]}}},t.addEventListener("tick",p._updateRoot);var v=function(a,b,c){var e,d=a._gsTweenID;if(y[d||(a._gsTweenID=d="t"+D++)]||(y[d]={target:a,tweens:[]}),b&&(a=y[d].tweens,a[e=a.length]=b,c))for(;-1<--e;)a[e]===b&&a.splice(e,1);return y[d].tweens},G=function(a,b,c,d,e){var g,f,h;if(1===d||d>=4){for(a=e.length,g=0;a>g;g++)if((h=e[g])!==b)h._gc||h._enabled(!1,!1)&&(f=!0);else if(5===d)break;return f}var m,j=b._startTime+1e-10,k=[],l=0;for(g=e.length;-1<--g;)(h=e[g])===b||h._gc||h._paused||(h._timeline!==b._timeline?(m=m||I(b,0),0===I(h,m)&&(k[l++]=h)):h._startTime<=j&&h._startTime+h.totalDuration()/h._timeScale+1e-10>j&&((0===b._duration||!h._initted)&&2e-10>=j-h._startTime||(k[l++]=h)));for(g=l;-1<--g;)h=k[g],2===d&&h._kill(c,a)&&(f=!0),(2!==d||!h._firstPT&&h._initted)&&h._enabled(!1,!1)&&(f=!0);return f},I=function(a,b){for(var c=a._timeline,d=c._timeScale,e=a._startTime;c._timeline;){if(e+=c._startTime,d*=c._timeScale,c._paused)return-100;c=c._timeline}return e/=d,e>b?e-b:!a._initted&&2e-10>e-b?1e-10:(e=e+a.totalDuration()/a._timeScale/d+1e-10)>b?0:e-b-1e-10};c._init=function(){this.vars.startAt&&(this.vars.startAt.overwrite=0,this.vars.startAt.immediateRender=!0,m.to(this.target,0,this.vars.startAt));var a,b;if(this._ease=this.vars.ease instanceof z?this.vars.easeParams instanceof Array?this.vars.ease.config.apply(this.vars.ease,this.vars.easeParams):this.vars.ease:"function"==typeof this.vars.ease?new z(this.vars.ease,this.vars.easeParams):m.defaultEase,this._easeType=this._ease._type,this._easePower=this._ease._power,this._firstPT=null,this._targets)for(a=this._targets.length;-1<--a;)this._initProps(this._targets[a],this._propLookup[a]={},this._siblings[a],this._overwrittenProps?this._overwrittenProps[a]:null)&&(b=!0);else b=this._initProps(this.target,this._propLookup,this._siblings,this._overwrittenProps);if(b&&m._onPluginEvent("_onInitAllProps",this),this._overwrittenProps&&null==this._firstPT&&"function"!=typeof this.target&&this._enabled(!1,!1),this.vars.runBackwards)for(a=this._firstPT;a;)a.s+=a.c,a.c=-a.c,a=a._next;this._onUpdate=this.vars.onUpdate,this._initted=!0},c._initProps=function(a,b,c,d){var e,g,f,h,j;if(null==a)return!1;for(e in this.vars){if(C[e]){if(("onStartParams"===e||"onUpdateParams"===e||"onCompleteParams"===e||"onReverseCompleteParams"===e||"onRepeatParams"===e)&&(j=this.vars[e]))for(g=j.length;-1<--g;)"{self}"===j[g]&&(j=this.vars[e]=j.concat(),j[g]=this)}else if(x[e]&&(h=new x[e])._onInitTween(a,this.vars[e],this)){for(this._firstPT={_next:this._firstPT,t:h,p:"setRatio",s:0,c:1,f:!0,n:e,pg:!0,pr:h._priority},g=h._overwriteProps.length;-1<--g;)b[h._overwriteProps[g]]=this._firstPT;(h._priority||h._onInitAllProps)&&(f=!0),(h._onDisable||h._onEnable)&&(this._notifyPluginsOfEnabled=!0)}else this._firstPT=b[e]={_next:this._firstPT,t:a,p:e,f:"function"==typeof a[e],n:e,pg:!1,pr:0},this._firstPT.s=this._firstPT.f?a[e.indexOf("set")||"function"!=typeof a["get"+e.substr(3)]?e:"get"+e.substr(3)]():parseFloat(a[e]),this._firstPT.c="number"==typeof this.vars[e]?this.vars[e]-this._firstPT.s:"string"==typeof this.vars[e]?parseFloat(this.vars[e].split("=").join("")):0;this._firstPT&&this._firstPT._next&&(this._firstPT._next._prev=this._firstPT)}return d&&this._kill(d,a)?this._initProps(a,b,c,d):1<this._overwrite&&this._firstPT&&1<c.length&&G(a,this,b,this._overwrite,c)?(this._kill(b,a),this._initProps(a,b,c,d)):f},c.render=function(a,b,c){var e,g,d=this._time;if(a>=this._duration)this._totalTime=this._time=this._duration,this.ratio=this._ease._calcEnd?this._ease.getRatio(1):1,this._reversed||(e=!0,g="onComplete"),0===this._duration&&((0===a||0>this._rawPrevTime)&&this._rawPrevTime!==a&&(c=!0),this._rawPrevTime=a);
else if(0>=a)this._totalTime=this._time=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0,(0!==d||0===this._duration&&0<this._rawPrevTime)&&(g="onReverseComplete",e=this._reversed),0>a?(this._active=!1,0===this._duration&&(0<=this._rawPrevTime&&(c=!0),this._rawPrevTime=a)):this._initted||(c=!0);else if(this._totalTime=this._time=a,this._easeType){var f=a/this._duration,h=this._easeType,j=this._easePower;(1===h||3===h&&f>=.5)&&(f=1-f),3===h&&(f*=2),1===j?f*=f:2===j?f*=f*f:3===j?f*=f*f*f:4===j&&(f*=f*f*f*f),this.ratio=1===h?1-f:2===h?f:.5>a/this._duration?f/2:1-f/2}else this.ratio=this._ease.getRatio(a/this._duration);if(this._time!==d||c){for(this._initted||(this._init(),!e&&this._time&&(this.ratio=this._ease.getRatio(this._time/this._duration))),!this._active&&!this._paused&&(this._active=!0),0!==d||!this.vars.onStart||0===this._time&&0!==this._duration||b||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||u),a=this._firstPT;a;)a.f?a.t[a.p](a.c*this.ratio+a.s):a.t[a.p]=a.c*this.ratio+a.s,a=a._next;this._onUpdate&&(b||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||u)),g&&!this._gc&&(e&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),b||this.vars[g]&&this.vars[g].apply(this.vars[g+"Scope"]||this,this.vars[g+"Params"]||u))}},c._kill=function(a,b){if("all"===a&&(a=null),null==a&&(null==b||b==this.target))return this._enabled(!1,!1);var c,d,e,f,g,h,j,b=b||this._targets||this.target;if((b instanceof Array||b.jquery)&&"object"==typeof b[0])for(c=b.length;-1<--c;)this._kill(a,b[c])&&(g=!0);else{if(this._targets){for(c=this._targets.length;-1<--c;)if(b===this._targets[c]){f=this._propLookup[c]||{},this._overwrittenProps=this._overwrittenProps||[],d=this._overwrittenProps[c]=a?this._overwrittenProps[c]||{}:"all";break}}else{if(b!==this.target)return!1;f=this._propLookup,d=this._overwrittenProps=a?this._overwrittenProps||{}:"all"}if(f)for(e in h=a||f,j=a!=d&&"all"!=d&&a!=f&&(null==a||1!=a._tempKill),h)(c=f[e])&&(c.pg&&c.t._kill(h)&&(g=!0),c.pg&&0!==c.t._overwriteProps.length||(c._prev?c._prev._next=c._next:c===this._firstPT&&(this._firstPT=c._next),c._next&&(c._next._prev=c._prev),c._next=c._prev=null),delete f[e]),j&&(d[e]=1)}return g},c.invalidate=function(){return this._notifyPluginsOfEnabled&&m._onPluginEvent("_onDisable",this),this._onUpdate=this._overwrittenProps=this._firstPT=null,this._initted=this._active=this._notifyPluginsOfEnabled=!1,this._propLookup=this._targets?{}:[],this},c._enabled=function(a,b){if(a&&this._gc)if(this._targets)for(var c=this._targets.length;-1<--c;)this._siblings[c]=v(this._targets[c],this,!0);else this._siblings=v(this.target,this,!0);return p.prototype._enabled.call(this,a,b),this._notifyPluginsOfEnabled&&this._firstPT?m._onPluginEvent(a?"_onEnable":"_onDisable",this):!1},m.to=function(a,b,c){return new m(a,b,c)},m.from=function(a,b,c){return c.runBackwards=!0,0!=c.immediateRender&&(c.immediateRender=!0),new m(a,b,c)},m.fromTo=function(a,b,c,d){return d.startAt=c,c.immediateRender&&(d.immediateRender=!0),new m(a,b,d)},m.delayedCall=function(a,b,c,d,e){return new m(b,0,{delay:a,onComplete:b,onCompleteParams:c,onCompleteScope:d,onReverseComplete:b,onReverseCompleteParams:c,onReverseCompleteScope:d,immediateRender:!1,useFrames:e,overwrite:0})},m.set=function(a,b){return new m(a,0,b)},m.killTweensOf=m.killDelayedCallsTo=function(a,b){for(var c=m.getTweensOf(a),d=c.length;-1<--d;)c[d]._kill(b,a)},m.getTweensOf=function(a){if(null!=a){var b,c,d;if((a instanceof Array||a.jquery)&&"object"==typeof a[0]){for(b=a.length,c=[];-1<--b;)c=c.concat(m.getTweensOf(a[b]));for(b=c.length;-1<--b;)for(d=c[b],a=b;-1<--a;)d===c[a]&&c.splice(b,1)}else for(c=v(a).concat(),b=c.length;-1<--b;)c[b]._gc&&c.splice(b,1);return c}};var H=l("plugins.TweenPlugin",function(a,b){this._overwriteProps=(a||"").split(","),this._propName=this._overwriteProps[0],this._priority=b||0},!0);if(c=H.prototype,H.version=12,H.API=2,c._firstPT=null,c._addTween=function(a,b,c,d,e,f){var g;null!=d&&(g="number"==typeof d||"="!==d.charAt(1)?Number(d)-c:Number(d.split("=").join("")))&&(this._firstPT={_next:this._firstPT,t:a,p:b,s:c,c:g,f:"function"==typeof a[b],n:e||b,r:f},this._firstPT._next&&(this._firstPT._next._prev=this._firstPT))},c.setRatio=function(a){for(var c,b=this._firstPT;b;)c=b.c*a+b.s,b.r&&(c=c+(c>0?.5:-.5)>>0),b.f?b.t[b.p](c):b.t[b.p]=c,b=b._next},c._kill=function(a){if(null!=a[this._propName])this._overwriteProps=[];else for(var b=this._overwriteProps.length;-1<--b;)null!=a[this._overwriteProps[b]]&&this._overwriteProps.splice(b,1);for(b=this._firstPT;b;)null!=a[b.n]&&(b._next&&(b._next._prev=b._prev),b._prev?(b._prev._next=b._next,b._prev=null):this._firstPT===b&&(this._firstPT=b._next)),b=b._next;return!1},c._roundProps=function(a,b){for(var c=this._firstPT;c;)(a[this._propName]||null!=c.n&&a[c.n.split(this._propName+"_").join("")])&&(c.r=b),c=c._next},m._onPluginEvent=function(a,b){var d,c=b._firstPT;if("_onInitAllProps"===a){for(var e,f,g,h;c;){for(h=c._next,e=f;e&&e.pr>c.pr;)e=e._next;(c._prev=e?e._prev:g)?c._prev._next=c:f=c,(c._next=e)?e._prev=c:g=c,c=h}c=b._firstPT=f}for(;c;)c.pg&&"function"==typeof c.t[a]&&c.t[a]()&&(d=!0),c=c._next;return d},H.activate=function(a){for(var b=a.length;-1<--b;)a[b].API===H.API&&(m._plugins[(new a[b])._propName]=a[b]);return!0},f=g._gsQueue){for(h=0;h<f.length;h++)f[h]();for(c in b)b[c].def||console.log("Warning: TweenLite encountered missing dependency: com.greensock."+c)}}(window),function(){function original(){var tl=new TimelineMax;tl.to(brick1,.1,{css:{top:0,left:0,rotation:"180"},ease:Expo.easeOut}),tl.to(brick2,.1,{css:{top:0,left:15,rotation:"180"},ease:Expo.easeOut}),tl.to(brick3,.1,{css:{top:0,left:30,rotation:"180"},ease:Expo.easeOut}),tl.to(brick4,.1,{css:{top:0,left:45,rotation:"180"},ease:Expo.easeOut}),tl.to(brick5,.1,{css:{top:15,left:0,rotation:"180"},ease:Expo.easeOut}),tl.to(brick6,.1,{css:{top:15,left:15,rotation:"180"},ease:Expo.easeOut}),tl.to(brick7,.1,{css:{top:15,left:30,rotation:"180"},ease:Expo.easeOut}),tl.to(brick8,.1,{css:{top:15,left:45,rotation:"180"},ease:Expo.easeOut}),tl.to(brick9,.1,{css:{top:30,left:0,rotation:"180"},ease:Expo.easeOut}),tl.to(brick10,.1,{css:{top:30,left:15,rotation:"180"},ease:Expo.easeOut}),tl.to(brick11,.1,{css:{top:30,left:30,rotation:"180"},ease:Expo.easeOut}),tl.to(brick12,.1,{css:{top:30,left:45,rotation:"180"},ease:Expo.easeOut}),tl.to(brick13,.1,{css:{top:45,left:0,rotation:"180"},ease:Expo.easeOut}),tl.to(brick14,.1,{css:{top:45,left:15,rotation:"180"},ease:Expo.easeOut}),tl.to(brick15,.1,{css:{top:45,left:30,rotation:"180"},ease:Expo.easeOut}),tl.to(brick16,.1,{css:{top:45,left:45,rotation:"180"},ease:Expo.easeOut})}function logoHover(){var hover=new TimelineMax;hover.to(brick1,.1,{css:{top:45,left:45,rotation:"180"},ease:Expo.easeOut}),hover.to(brick2,.1,{css:{top:45,left:30,rotation:"180"},ease:Expo.easeOut}),hover.to(brick3,.1,{css:{top:45,left:15,rotation:"180"},ease:Expo.easeOut}),hover.to(brick4,.1,{css:{top:45,left:0,rotation:"180"},ease:Expo.easeOut}),hover.to(brick5,.1,{css:{top:30,left:45,rotation:"180"},ease:Expo.easeOut}),hover.to(brick6,.1,{css:{top:30,left:30,rotation:"180"},ease:Expo.easeOut}),hover.to(brick7,.1,{css:{top:30,left:15,rotation:"180"},ease:Expo.easeOut}),hover.to(brick8,.1,{css:{top:30,left:0,rotation:"180"},ease:Expo.easeOut}),hover.to(brick9,.1,{css:{top:15,left:45,rotation:"180"},ease:Expo.easeOut}),hover.to(brick10,.1,{css:{top:15,left:30,rotation:"180"},ease:Expo.easeOut}),hover.to(brick11,.1,{css:{top:15,left:15,rotation:"180"},ease:Expo.easeOut}),hover.to(brick12,.1,{css:{top:15,left:0,rotation:"180"},ease:Expo.easeOut}),hover.to(brick13,.1,{css:{top:0,left:45,rotation:"180"},ease:Expo.easeOut}),hover.to(brick14,.1,{css:{top:0,left:30,rotation:"180"},ease:Expo.easeOut}),hover.to(brick15,.1,{css:{top:0,left:15,rotation:"180"},ease:Expo.easeOut}),hover.to(brick16,.1,{css:{top:0,left:0,rotation:"180"},ease:Expo.easeOut})}logo=document.getElementById("logo"),brick1=document.getElementById("brick1"),brick2=document.getElementById("brick2"),brick3=document.getElementById("brick3"),brick4=document.getElementById("brick4"),brick5=document.getElementById("brick5"),brick6=document.getElementById("brick6"),brick7=document.getElementById("brick7"),brick8=document.getElementById("brick8"),brick9=document.getElementById("brick9"),brick10=document.getElementById("brick10"),brick11=document.getElementById("brick11"),brick12=document.getElementById("brick12"),brick13=document.getElementById("brick13"),brick14=document.getElementById("brick14"),brick15=document.getElementById("brick15"),brick16=document.getElementById("brick16"),original(),logo.addEventListener("mouseover",logoHover,!1),logo.addEventListener("mouseleave",original,!1),$(document).ready(function(){$("#menu").click(function(){$(this).toggleClass("open"),$("#nav-wrap").toggleClass("open"),$("#feed").toggleClass("close");var winH=$(window).height(),navH=$("nav").height();$("nav").css({marginTop:(winH-navH)/2})})}),$(window).ready(function(){$("header h1").fadeIn(1e3)}),$(".wrapper").height($(window).height())}(),$(window).resize(function(){$(".wrapper").height($(window).height());var winH=$(window).height(),navH=$("nav").height();$("nav").css({marginTop:(winH-navH)/2})});